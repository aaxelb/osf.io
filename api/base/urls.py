    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r"^citations/", include("api.citations.urls", namespace="citations")
                ),
                url(
                    r"^collections/",
                ...
                url(
                    r"^preprints/", include("api.preprints.urls", namespace="preprints")
                ),
                url(
                ...
                url(
                    r"^providers/", include("api.providers.urls", namespace="providers")
                ),
                url(
                    r"^registrations/",
