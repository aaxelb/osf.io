...
class TestGetApprovalStatus:
    ...
    def draft_approved_and_registered(self, user, project):
        ...
        draft.registered_node = RegistrationFactory(
            creator=user, project=project, is_public=True
        )
        draft.save()
        return draft
