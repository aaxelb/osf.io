...
class TestUserSystemTagNormalization:
    ...
    def test_user_system_tags_normalization(
        self,
        legacy_system_tags,
        ...
        prereg_challenge_user_created_before_cutoff.add_system_tag(
            prereg_challenge_source_tag
        )
        prereg_challenge_user_created_after_cutoff.add_system_tag(
            prereg_challenge_source_tag
        )
        add_prereg_campaign_tags()
        assert (
            CampaignSourceTags.PreregChallenge.value
            in prereg_challenge_user_created_before_cutoff.system_tags
        )
        assert (
            CampaignSourceTags.Prereg.value
            not in prereg_challenge_user_created_before_cutoff.system_tags
        )
        assert (
            CampaignSourceTags.Prereg.value
            in prereg_challenge_user_created_after_cutoff.system_tags
        )
        assert (
            CampaignSourceTags.PreregChallenge.value
            not in prereg_challenge_user_created_after_cutoff.system_tags
        )
