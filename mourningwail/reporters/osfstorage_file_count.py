...
from mourningwail.metrics.reports import OsfstorageFileCountReportV0
    ...
    def keen_events_from_report(self, report):
        event = {
            'osfstorage_files_including_quickfiles': {
                ...
                'total_daily': report.total_daily,
                'public_daily': report.public_daily,
                'private_daily': report.private_daily,
            },
        }
