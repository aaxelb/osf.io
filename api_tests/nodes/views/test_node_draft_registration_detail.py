    ...
    def test_required_metaschema_questions_not_required_on_update(
        ...
        payload = {
            "data": {
                ...
                "type": "draft_registrations",
                "attributes": {
                    "registration_metadata": {"q2": {"value": "New response"}}
                },
            }
        }
        ...
        assert res.status_code == 200
        assert (
            res.json["data"]["attributes"]["registration_metadata"]["q2"]["value"]
            == "New response"
        )
    ...
    def test_reviewer_can_update_draft_registration(
        ...
        payload = {
            "data": {
                ...
                "attributes": {
                    "registration_metadata": {
                        "q2": {"comments": [{"value": "This is incomplete."}]}
                    }
                },
            }
        }
        ...
        assert res.status_code == 200
        assert (
            res.json["data"]["attributes"]["registration_metadata"]["q2"]["comments"][
                0
            ]["value"]
            == "This is incomplete."
        )
    ...
    def test_reviewer_can_only_update_comment_fields_draft_registration(
        ...
        payload = {
            "data": {
                ...
                "type": "draft_registrations",
                "attributes": {
                    "registration_metadata": {"q2": {"value": "Test response"}}
                },
            }
        }
        ...
        assert (
            ...
            == "For your registration your response to the 'Authors' field is invalid."
        )
    ...
    def test_reviewer_cannot_update_nested_value_fields_draft_registration(
        ...
        payload = {
            "data": {
                ...
                "attributes": {
                    "registration_metadata": {
                        "q7": {"value": {"question": {"value": "This is the answer"}}}
                    }
                },
            }
        }
