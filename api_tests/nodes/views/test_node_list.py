...
class TestNodeList:
    ...
    def test_default_node_permission_queryset(
        self, app, url, private_project, user, sparse_url, is_sparse
    ):
        url = sparse_url if is_sparse else url
...
class TestNodeCreate:
    ...
    def test_create_node_errors(
        self, app, user_one, public_project, private_project, url, sparse_url
    ):
        ...
        res = app.post_json_api(
            sparse_url, public_project, expect_errors=True, auth=user_one.auth
        )
